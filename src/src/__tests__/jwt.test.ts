...
describe("JWT", () => {
  ...
  describe("Middleware verifyToken", () => {
    it("should return an error message with code 403 if the token is missing", async () => {
    ...
    it("should return an error message with code 403 if the token is invalid", async () => {
      const response = await supertest(app)
        .get("/users")
